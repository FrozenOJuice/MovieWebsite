"""Core token management utilities for revocation and cleanup.

Centralizes:
- Token blacklist (revocation) handling
- Expiry cleanup
- Revoked token checks

Used by both authentication/security.py and any system-level task
that needs to invalidate or verify tokens.
"""
